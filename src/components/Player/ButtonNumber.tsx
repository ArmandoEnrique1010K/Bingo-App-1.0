    ...
    return (
        <>
            <button
                ...
                className={`text-2xl font-bold w-16 h-16 border-none rounded-lg text-white hover:bg-cyan-700 active:bg-cyan-600 transition duration-300 ${handleSelectedNumber(n.number, n.position) === true ? "bg-cyan-500" : "bg-gray-500"}`}
